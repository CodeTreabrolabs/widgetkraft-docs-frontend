...
const HTML_CODE = `<!-- 1. Add this where you want the contact form to appear -->
...
export default function App() {
  ...
  return (
    <div>
      {/* Your app content */}
      <div id="contactform-root" />
    </div>
  );
}`;

const NEXTJS_CODE = `// components/ContactFormWidget.js
'use client';
...
export default function ContactFormWidget() {
  ...
  return <div id="contactform-root" />;
}
...
const descMap = {
  ...
  react:  'Drop this into your root component the contact form loads automatically on mount.',
