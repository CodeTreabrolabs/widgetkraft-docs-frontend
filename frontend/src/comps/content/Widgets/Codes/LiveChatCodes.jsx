...
const HTML_CODE = `<!-- 1. Add this where you want the live chat to appear -->
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (window.LiveChatWidget) {
      window.LiveChatWidget.setUser(user);
      return;
    }
...
const NEXTJS_CODE = `// app/layout.js
'use client';
...
const descMap = {
  ...
  react:  'Drop this into your root component optionally pass user info to identify visitors.',
  nextjs: 'Create a Client Component, pass your auth user as a prop for automatic identification.',
};
    ...
    <section className="mb-10">
      ...
      <div className="mb-6">
        ...
        <p className="text-[var(--docs-steel)]">
          Copy the snippet for your stack and paste it into your project your live chat widget is live in under a minute.
        </p>
      </div>
      ...
      <div className="docs-code-panel">
        ...
        <div className="px-5 py-3 border-t border-gray-700 bg-gray-900/40 flex items-center gap-2 flex-wrap gap-y-1">
          ...
          <span className="text-[var(--docs-stone)] text-xs">
            ...
            <strong className="text-[var(--docs-steel)]">Code</strong> tab of your live chat editor.{' '}
            <code className="docs-inline-code text-[11px]">
              setUser
            </code>{' '}
            is optional remove it for anonymous visitors.
          </span>
        </div>
      </div>
    </section>
